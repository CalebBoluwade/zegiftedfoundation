    ...
    <header className="bg-white shadow-lg h-24 hidden md:flex">
      ...
      <nav className="header-links contents font-semibold text-base lg:text-lg">
        <ul className="flex items-center ml-4 xl:ml-8 mr-auto">
          <li className="p-3 xl:p-6 hover:bg-gray-50 hover:text-gray-700 active">
            <a href="">
              <span>Home</span>
            </a>
          </li>
          <li className="p-3 xl:p-6 hover:bg-gray-50 hover:text-gray-700">
            <a href="">
              <span>Programs</span>
            </a>
          </li>
          ...
          <li className="p-3 xl:p-6 hover:bg-gray-50 hover:text-gray-700">
            <a href="" className="flex items-center">
              ...
              <svg
                ...
                viewBox="0 0 448 512"
                //className="svg-inline--fa fa-chevron-down fa-w-14 fa-7x"
              >
                <path
                  fill="currentColor"
